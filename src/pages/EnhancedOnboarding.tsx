...
const EnhancedOnboarding = () => {
  ...
  const completeOnboarding = async () => {
    ...
    try {
      ...
      toast.success("Welcome to Love Story! 🎉");
      navigate('/dashboard');
    } catch (error) {
        ...
        return (
          <div className="space-y-6 text-center">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl font-bold">Welcome to Love Story! 💕</h1>
        ...
        return (
          <div className="space-y-6 text-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-lg">
                Welcome to your relationship journey with Love Story
              </p>
            </div>
