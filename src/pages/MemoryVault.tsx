      ...
      <GradientHeader title="Memory Vault" subtitle="Your love story collection" icon={<Heart size={24} />} showBackButton={false}>
        ...
        <Tabs value={filterType} onValueChange={value => setFilterType(value as typeof filterType)} className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="all" className="my-0 py-[2px]">All</TabsTrigger>
            <TabsTrigger value="photos" className="py-[2px]">Photos</TabsTrigger>
            <TabsTrigger value="notes" className="py-[2px]">Notes</TabsTrigger>
            <TabsTrigger value="favorites" className="py-[2px]">★ Favorites</TabsTrigger>
          </TabsList>
        </Tabs>
      </GradientHeader>
