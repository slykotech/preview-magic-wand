      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {initialType === 'rating' ? 'Rate Love Story' : 'Send Feedback'}
          </DialogTitle>
          <DialogDescription>
            {initialType === 'rating' 
              ? 'How would you rate your experience with Love Story?'
              : 'Help us improve Love Story with your feedback'
            }
          </DialogDescription>
        </DialogHeader>
            ...
            <div>
              ...
              {rating > 0 && (
                <p className="text-sm text-muted-foreground mt-1">
                  ...
                  {rating === 5 && "Wonderful! We're so happy you love Love Story! ❤️"}
                </p>
              )}
            </div>
          )}
