      ...
      <CardContent className="p-3 sm:p-4">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-4">
          ...
          <div className="text-center">
            <div className={`bg-gradient-to-br ${getStreakColor(checkinStreak)} rounded-full p-2 sm:p-3 mx-auto w-fit mb-1 sm:mb-2 shadow-elegant`}>
              <Calendar className="text-white" size={20} />
            </div>
            <p className="text-xl sm:text-2xl font-bold text-white">{checkinStreak}</p>
          ...
          {/* Story Streak */}
          <div className="text-center">
            <div className={`bg-gradient-to-br ${getStreakColor(storyStreak)} rounded-full p-2 sm:p-3 mx-auto w-fit mb-1 sm:mb-2 shadow-elegant`}>
              <Flame className="text-white" size={20} />
            </div>
            <p className="text-xl sm:text-2xl font-bold text-white">{storyStreak}</p>
