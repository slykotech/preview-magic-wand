-- Clean up existing incorrect cron jobs that call non-existent function
SELECT cron.unschedule('invoke-scheduled-event-fetcher-every-4-hours');
SELECT cron.unschedule('invoke-scheduled-event-fetcher-hourly');
SELECT cron.unschedule('invoke-scheduled-event-fetcher-daily');
