-- Update the calculate_enhanced_sync_score function to use 0% base score instead of 50%
...
BEGIN
  ...
  -- Total range: 0 + (-28 to +73) = -28 to 73, capped at 0-100
  final_score := 0 + checkin_points + story_points + communication_points + milestone_points + streak_bonus;
  ...
  INSERT INTO historical_sync_scores (
    ...
    streak_bonus,
    jsonb_build_object(
      'calculation_details', 'Enhanced algorithm v3.1 - starts from 0% base with penalties/rewards',
