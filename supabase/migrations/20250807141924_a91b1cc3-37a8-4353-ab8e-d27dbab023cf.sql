-- Create the missing functions that were referenced in the TypeScript errors

-- Function to get premium access details
...
DROP TRIGGER IF EXISTS update_partner_subscriptions_updated_at ON public.partner_subscriptions;
