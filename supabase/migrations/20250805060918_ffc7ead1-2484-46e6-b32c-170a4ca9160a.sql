-- Update invalid status values first
...
-- Add unique constraint that allows demo connections but prevents duplicate pairs
...
-- Ensure partner_requests table has all required constraints
